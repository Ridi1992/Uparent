package com.lingwei.materialcalculator.view;
 ...
 * 
 *  Notes:
 * 	$Id: CropImage.java 72642  2015-8-6	14:01:57Z Lexing\leshuanggang $ 
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
 *  2015-8-6		乐双�? Initial.
...
public class CropImage {
	...
	private Bitmap onSaveClicked(Bitmap bm) {
		...
		int width = 480;// dr.width(); // modify by yc
		int height = 480;// dr.height();
	...
	public String saveToLocal(Bitmap bm) {
		...
		try {
			...
			Log.e("-------cropImage---saveToLocal-----",e.getMessage()+"");
			return null;
		} catch (IOException e) {
		    Log.e("-------cropImage---saveToLocal-----",e.getMessage()+"");
			return null;
