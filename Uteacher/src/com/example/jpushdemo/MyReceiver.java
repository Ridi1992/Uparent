...
import com.lester.uteacher.MainActivity;
...
//		processCustomMessage(context, bundle);
	...
	private static String printBundle(Bundle bundle) {
		...
		for (String key : bundle.keySet()) {
			if(key.equals("cn.jpush.android.EXTRA")){
				System.out.println("消息内容是："+bundle.getString(key));//在这里做json的处理
			}
			if(key.equals("cn.jpush.android.MESSAGE")){
				System.out.println("message："+bundle.getString(key));//在这里做json的处理
			}
	...
	private void processCustomMessage(Context context, Bundle bundle) {
		if (MainActivity.isForeground) {
			...
			System.out.println("jpsu==="+showMsg);
