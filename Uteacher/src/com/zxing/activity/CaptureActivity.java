...
import com.lester.uteacher.CodeDetail;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			FrameLayout.LayoutParams rl = new FrameLayout.LayoutParams((int) (height*(3.0/4.0)), height);
	        preview_view.setLayoutParams(rl); 
