...
public final class Announcement extends Activity{
	...
	private void initview() {
		Texttool.setText(Announcement.this, R.id.bartitle, "校园公告");
	...
	private void getannouncement() {
		...
		new Thread(new Runnable() {
	        public void run() {
	            ...
	            String params = "{schoolId:'"+Userinfo.getschoolid(Announcement.this)+
	            		"',pageNum:"+pageNum+
	            		",pageSize:"+pageSize+
	            		",maxTime:'"+maxtime+
	            		"'}";
