...
import com.lester.uteacher.mystudent.GetMessgae;
import com.lester.uteacher.mystudent.Student;
import com.lester.uteacher.mystudent.Student.parents;
...
public class Sendmessage extends Activity implements OnClickListener{
	...
	requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		datas=(parents) getIntent().getSerializableExtra("datas");
	...
	public void onClick(View v) {
		...
		case R.id.makesure:
			...
			if(Texttool.Gettext((TextView) findViewById(R.id.abnormalReason)).length()>50){
				Toast.makeText(getApplicationContext(), "消息长度不能大于50，当前长度为"+
	...
	Handler handler=new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case Constants.GETMESSAGE:
				list = (ArrayList<com.lester.uteacher.mystudent.GetMessgae.datas>) msg.obj;
	...
	private void privateChatService() {
		...
		new Thread(new Runnable() {
	        public void run() {
	            ...
	            String params = "{loginId:'"+datas.getParentMobilePhone()+
	...
	new Thread(new Runnable() {
        public void run() {
            ...
            String params = "{loginId:'"+Userinfo.getmobile_phone(Sendmessage.this)+
            		"',receiverLoginId:'"+datas.getParentMobilePhone()+
            		"',receiverName:'"+datas.getParentName()+
