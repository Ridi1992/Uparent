package com.lester.uparent.login;
...
public class logindata implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4345936769572146439L;

	public class data implements Serializable{
       /**
		 * 
		 */
		private static final long serialVersionUID = 8224012583807906990L;
       ...
       private String id;
       private String education_display;
       ...
       private boolean isDefalutPhoto;//是否修改头像
       
       
	public boolean isDefalutPhoto() {
		return isDefalutPhoto;
	}
	public void setDefalutPhoto(boolean isDefalutPhoto) {
		this.isDefalutPhoto = isDefalutPhoto;
	}
	/**
	 * @return the birthday
	 */
	...
	/**
	 * @return the education_display
	 */
	public String getEducation_display() {
		return education_display;
	}
	/**
	 * @param education_display the education_display to set
	 */
	public void setEducation_display(String education_display) {
		this.education_display = education_display;
	}
	/**
