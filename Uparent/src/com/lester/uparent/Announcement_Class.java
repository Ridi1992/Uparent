...
public final class Announcement_Class extends ListActivity {
	...
	private void getannouncement() {
		if(Userinfo.getchildclassid(Announcement_Class.this)==null
				||Userinfo.getchildclassid(Announcement_Class.this).equals("")){
			handler.sendMessage(handler.obtainMessage(404,"学生未设置班级，请联系老师"));
			return;
		}
		...
		new Thread(new Runnable() {
	        public void run() {
	            ...
	            String params = 
	            		"{clazzId:'"+Userinfo.getchildclassid(Announcement_Class.this)+
	            		"',pageNum:"+pageNum+
	            		",pageSize:"+pageSize+
	            		",loginId:'"+Userinfo.getmobile_phone(Announcement_Class.this)+
	            		"',token:'"+token+
	            		"',maxTime:'"+maxtime+
	            		"'}";
