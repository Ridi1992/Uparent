...
public class Feedback_History extends Activity implements OnClickListener,OnItemClickListener{
	...
	private ArrayList<GetFeedbackdatalist> data;
		...
		public void handleMessage(android.os.Message msg) {
			try {
				...
				case Constants.GETFEEDBACKLIST:
					data=(ArrayList<GetFeedbackdatalist>) msg.obj;
					if(data!=null && data.size()!=0){
						mAdapter.notifyDataSetChanged();
					}else{
						Toast.makeText(getApplicationContext(), "还没有您的反馈信息", 0).show();
					}
					break;
				case 404:
	...
	private void getdata() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				String params = "{studentId:'"+userinfo.getchildid(Feedback_History.this)
						+"'}";
				...
				try {
					...
					if (jsonObj.getString("success").equals("true")) {
						...
						Object  object=JsonUtil.instance().fromJson(jsonData, new TypeToken<ArrayList<GetFeedbackdatalist>>(){}.getType());
