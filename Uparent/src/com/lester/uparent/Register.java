...
public class Register  extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.makesure://确认
			...
			if(!Texttool.Patternidcard(str)){
				Toast.makeText(getApplicationContext(), "请输入正确的家长身份证号", 0).show();
				break;
			}
			...
			if(!Texttool.Havecontent((TextView) findViewById(R.id.studentName))){
				Toast.makeText(getApplicationContext(), "小孩姓名不能为空", 0).show();
				break;
				}
			if(!Texttool.Havecontent((TextView) findViewById(R.id.studentIdCart))){
				Toast.makeText(getApplicationContext(), "小孩身份证不能为空", 0).show();
				break;
				}
			String str1=((EditText) findViewById(R.id.studentIdCart)).getText().toString();
			if(!Texttool.Patternidcard(str1)){
				Toast.makeText(getApplicationContext(), "请输入正确的小孩身份证号", 0).show();
				break;
			}
			...
			studentName=Texttool.Gettext((TextView) findViewById(R.id.studentName));
			studentIdCart=Texttool.Gettext((TextView) findViewById(R.id.studentIdCart));
